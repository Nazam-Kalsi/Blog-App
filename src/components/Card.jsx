  ...
  return (
    ...
    <Link to={`/post/${$id}`}>
      <div className='py-4 px-8  min-w-80 border border-gray-500 rounded-xl hover:bg-black hover:scale-[1.01] transition-all'>
        <div className='mx-auto overflow-hidden bh-64 border w-5/6 '>
          <img src={dbService.preview(featuredImage)} alt={Title} className='w-5/6 mx-auto border rounded-xl size-40 '/> 
